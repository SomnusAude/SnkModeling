...
def wallCollision(particle:ParticleElement):
	posX = particle.posX
	posY = particle.posY
	...
	if speedY > 0 and (posY+size)> 10:
		particle.speedY = -speedY

def movement(particle:ParticleElement, timeDelta:float):
	posX = particle.posX
	posY = particle.posY
	speedX = particle.speedX
	speedY = particle.speedY
